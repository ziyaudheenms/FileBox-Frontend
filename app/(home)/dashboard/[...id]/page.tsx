...
import { IconAdjustmentsAlt, IconClock, IconCloudComputing, IconCopyX, IconDotsVertical, IconDownload, IconFileUpload, IconFolder, IconFolderOpen, IconGrid4x4, IconGridDots, IconHome, IconLayoutGridRemove, IconList, IconServer, IconShare, IconUpload } from '@tabler/icons-react'
...
function page() {
    ...
    const [folderFileData, setFolderFileData] = useState<Array<FileFolderProps>>([])
                            ...
                            <div className="grid grid-cols-4 gap-4 py-5 ">
                                {folderFileData.map((item) => (
                                    <div key={item.id} className='border border-neutral-800 rounded-lg hover:border-neutral-700 '>
                                        {
                                            item.isfolder ? (
                                                <Link href={`${params.id ? params.id[params.id.length - 1] as string : undefined}/${item.id}`}>
                                                ...
                                                <Link href={`http://localhost:3000/images/1`} >
                                        ...
                                        <div className='flex flex-col pt-2 px-2'>
                                            <div className='flex items-center justify-between pb-2'>
                                                <h1 className='text-md text-neutral-100 font-figtree font-medium'>{item.name}</h1>
                                                <DropdownMenu>
                ...
                <div className='w-[27%] px-2 py-2 flex flex-col gap-3 h-screen overflow-y-scroll no-scrollbar'>
                    ...
                    {/* <Dialog>
                        <form>
                            ...
                            <DialogContent className="sm:max-w-[425px] bg-neutral-950 text-neutral-400 border border-neutral-800">
                                <AlertDialogHeader>
                                    <DialogTitle>Create Folder</DialogTitle>
                                </AlertDialogHeader>
                                <div className='w-full'>
                                    <InputGroup>
                                        <InputGroupInput className='text-neutral-100' placeholder='Enter the Name Of Folder' />
                                        <InputGroupAddon>
                                            <IconFolder />
                                        </InputGroupAddon>
                                    </InputGroup>
